...
interface StockFormProps {
  ...
  editingData?: StockFormData
}

export default function StockForm({ isOpen, onClose, onSubmit, editingData }: StockFormProps) {
  ...
  const renderStepContent = () => {
    switch (step) {
      case 1: // Identity
        return (
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white">Stock Identity</h3>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-3">
                {[
                  { value: 'long', label: 'Long', desc: 'Betting price goes up' },
      ...
      case 4: // Income & Targets
        return (
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white">Income & Targets</h3>
            
            <Card className="p-4">
              <h4 className="text-sm font-medium text-zinc-300 mb-3">Dividend Settings</h4>
              ...
              <div className="space-y-3">
                <label className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-sm text-zinc-300">Enable DRIP (Dividend Reinvestment)</span>
                </label>
                
                <div>
                  <label className="block text-sm text-zinc-400 mb-1">Dividend Tax Rate % (Optional)</label>
                  <Input
                    type="number"
                    min="0"
                    max="100"
                    step="0.1"
                    placeholder="15.0"
                    {...register('dividendTaxRate', { valueAsNumber: true })}
                  />
                  {errors.dividendTaxRate && (
                    <p className="text-red-400 text-xs mt-1">
                      {errors.dividendTaxRate.message}
                    </p>
                  )}
                </div>
              </div>
      ...
      case 5: // Privacy & Review
        return (
          <div className="space-y-4">
            ...
            {/* Final Review */}
            <Card className="p-4 bg-zinc-800/50">
              <h4 className="text-sm font-medium text-zinc-300 mb-3">Position Summary</h4>
        ...
        <div className="flex items-center justify-between p-6 border-b border-zinc-700">
          <div className="flex items-center space-x-3">
            <h2 className="text-xl font-semibold text-white">
              {editingData ? 'Edit Stock Position' : 'Add Stock Position'}
            </h2>
            ...
            <div className="flex items-center gap-3">
              {step < 5 ? (
                ...
                <Button type="submit" isLoading={isSubmitting}>
                  {editingData ? 'Update Position' : 'Add Position'}
                </Button>
              )}
            </div>
          </div>
